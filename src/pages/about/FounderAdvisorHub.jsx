  ...
  return (
    <div className="bg-paper">
      <PageHero
        backTo="/about"
        backLabel="About"
        kicker="Founders & Advisors"
        title={<>FOUNDERS &amp; ADVISORS<span className="text-azure">.</span></>}
        description="The people who built Clarity Group, and the advisors who guide it."
      />
